			...
			<div class="mt-5">
                <form action="/blog/store" method="post" enctype="multipart/form-data">
					...
					<div class="mb-3 space-y-2 w-full text-xs">
						...
						<input placeholder="Title article" class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg h-10 px-4" required="required" type="text" name="title" id="title">
					...
					<div class="mb-3 space-y-2 w-full text-xs">
						<div class="md:flex md:flex-row md:space-x-4 w-full text-xs">
                                <div class="w-full flex flex-col mb-3">
                                    ...
                                    <input placeholder="Author" class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg h-10 px-4" type="text" name="author" id="author">
                                </div>
						</div>
                    </div>
					<div class="flex-auto w-full mb-1 text-xs space-y-2">
						<label class="text-xl font-semibold text-gray-600 py-2">Content</label>
						<textarea required="" name="content" id="content" class="w-full min-h-[100px] max-h-[300px] h-28 appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg  py-4 px-4" placeholder="Enter content" spellcheck="false"></textarea>
