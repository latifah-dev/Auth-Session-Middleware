			...
			<div class="mt-5">
                <form action="/product/store" method="post" enctype="multipart/form-data">
					...
					<div class="mb-3 space-y-2 w-full text-xs">
						...
						<input placeholder="Product Name" class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg h-10 px-4" required="required" type="text" name="title" id="title">
					...
					<div class="mb-3 space-y-2 w-full text-xs">
						<div class="md:flex md:flex-row md:space-x-4 w-full text-xs">
                                <div class="w-full flex flex-col mb-3">
                                    ...
                                    <input placeholder="Price ex:200000" class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg h-10 px-4" type="text" name="price" id="price">
                                </div>
								<div class="w-full flex flex-col mb-3">
									<label class="text-xl font-semibold text-gray-600 py-2">Stock<abbr title="required">*</abbr></label>
									<input placeholder="Stock ex:200" class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg h-10 px-4" type="text" name="stock" id="stock">
					...
					<div class="flex-auto w-full mb-1 text-xs space-y-2">
						...
						<textarea required="" name="description" id="description" class="w-full min-h-[100px] max-h-[300px] h-28 appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg  py-4 px-4" placeholder="Enter description your product" spellcheck="false"></textarea>
